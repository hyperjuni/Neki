-- Modified to prevent NPCs from using Generic dialogue options with the Neki
...
function speciesDialog(dialog, targetId)
	...
	if dialog.generic and not dialog.neki then -- This is the only line that's been modified
